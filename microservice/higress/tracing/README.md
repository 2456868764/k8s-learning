...
[BLOG 原文地址](https://higress.io/zh-cn/blog/skywalking) 

## 一、整体架构图

![img.png](images/higress.png)
...
![img.png](images/skywalking1.png)
...
![img.png](images/skywalking_trace.png)
...
这里提供一键安装脚本 local-env-setup.sh 和 kind 配置文档 ingress_kin_config.yaml

ingress_kin_config.yaml 配置文件如下，配置 kind 集群一个控制节点，二个工作节点。
```yaml
# cluster.conf
kind: Cluster
...
```shell
$ export KUBECONFIG=/Users/jun/.kube/config_higress
...
```shell
$ kubectl apply -f envoyfilter_skywalking.yaml
```
...
![img.png](images/higress4-1.png)

- 调用链路截图

![img.png](images/higress4.png)

- 调用链路拓扑截图

![img.png](images/higress5.png)
