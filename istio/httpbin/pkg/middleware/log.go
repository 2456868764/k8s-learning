// ref https://github.com/gin-contrib/zap/blob/master/_example/example01/main.go
package middleware
...
func StartLogger(g *gin.Engine, option *options.Option) {
	logger := logs.Logger()
	g.Use(Ginzap(logger, time.RFC3339, true))
	g.Use(RecoveryWithZap(logger, true))
}
