...
func NewRootCommand() *cobra.Command {
	...
	rootCmd.Flags().StringVarP(&color, "favorite-color", "c", "red", "Should come from flag first, then env var DUBBO_FAVORITE_COLOR then the config file, then the default last")
